...
//nding elemenets using different locators(xpath functions)
...
//a[contains(text(),"Make Appointment") or @id = "btn-make-appointment"] Either true

//a[contains(text(),"Make Appointment") and @id = "btn-make-appointment"] both true

//a[normalize-space()="Make Appointment"] - TriM the head and trail spaces
