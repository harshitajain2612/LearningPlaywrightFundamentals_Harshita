...
Call log:
  - waiting for locator('[data-testid="profession-manual / profession-automation"]')
...
```ts
  ...
  18 | 
> 19 | await page.locator('[data-testid="profession-manual / profession-automation"]').check();
     |                                                                                 ^ Error: locator.check: Test timeout of 30000ms exceeded.
  20 | 
  21 | 
  22 | 
