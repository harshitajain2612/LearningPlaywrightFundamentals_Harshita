...
Call log:
  - waiting for getByRole('button', { name: 'gdpr_consent_checkbox', exact: true })
      ...
      - generic [ref=e34]:
        ...
        - generic [ref=e39]:
          ...
          - generic [ref=e43]:
            ...
            - generic [ref=e47]:
              - checkbox "I agree to VWO's Privacy Policy & Terms" [checked] [active] [ref=e48] [cursor=pointer]
...
```ts
  ...
  8  | 
  9  | await page.getByRole('checkbox', { name: /I agree/i }).check();
  10 | 
