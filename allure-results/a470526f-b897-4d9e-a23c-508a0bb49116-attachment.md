...
- Name: Projects\Project_6_WebTables\AutomateWebTable.spec.ts >> Hover Add on and click WIFI and verify the JSON
- Location: tests\Projects\Project_6_WebTables\AutomateWebTable.spec.ts:3:5
...
Call log:
  - waiting for getByText('Select Kabir.Khan')
...
```ts
  ...
  8  | 
> 9  | await page.getByText('Select Kabir.Khan').check();
     |                                           ^ Error: locator.check: Test timeout of 30000ms exceeded.
  10 | 
