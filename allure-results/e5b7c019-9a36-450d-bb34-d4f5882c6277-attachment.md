...
Call log:
  - waiting for locator('#frame-one').contentFrame().locator('#RESULT_TextField-4')
    - locator resolved to <input min="1990" max="2030" name="year" type="number" placeholder="2024" id="RESULT_TextField-4"/>
    - fill("Amzing car in a budget")
                ...
                - generic [ref=f1e7]:
                  ...
                  - generic [ref=f1e18]:
                    ...
                    - generic [ref=f1e22]:
                      ...
                      - spinbutton "Year" [active] [ref=f1e24]: "2016"
                  - generic [ref=f1e25]:
...
```ts
  ...
  12 |    
  13 |     await vehicleFrame.locator('#RESULT_TextField-3').fill("MH-12-AB-2612");
  14 | 
  15 |        
  16 |     await vehicleFrame.locator('#RESULT_RadioButton-1').selectOption('Hatchback');
  17 | 
  18 |      await vehicleFrame.locator('#RESULT_TextField-4').fill("2016");
  19 | 
> 20 |     await vehicleFrame.locator('#RESULT_TextField-4').fill("Amzing car in a budget");
     |                                                       ^ Error: locator.fill: Error: Cannot type text into input[type=number]
  21 | 
  22 |     await vehicleFrame.getByRole('button' , { name : 'Submit registration'}).click();
  23 | 
