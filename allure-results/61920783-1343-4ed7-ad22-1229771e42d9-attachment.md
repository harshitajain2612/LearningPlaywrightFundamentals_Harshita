...
Call log:
  - waiting for getByPlaceholder('you@example.coma')
...
```ts
  ...
  10 | 
  11 | 
> 12 | await page.getByPlaceholder("you@example.coma").fill("kimi@gmail.com");
     |                                                 ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  13 | 
  14 | await page.getByPlaceholder("••••••••").fill("Harshita@26");
  15 | 
  16 | 
  17 | 
  18 | });
